...
import { isTrueBoolean, isFalseBoolean, getCharaFilename } from '../../../utils.js';
import { saveSettingsDebounced, this_chid, characters } from '../../../../script.js';
import { SlashCommand } from '../../../slash-commands/SlashCommand.js';
import { ARGUMENT_TYPE, SlashCommandArgument, SlashCommandNamedArgument } from '../../../slash-commands/SlashCommandArgument.js';
import { SlashCommandParser } from '../../../slash-commands/SlashCommandParser.js';
import { getGroupMembers, findGroupMemberId, selected_group } from '../../../group-chats.js';
...
function getMGBCharName() {
    if (selected_group) {
		const MGBdisplayName = selected_group ? group?.name : characters[this_chid].name;
		console.debug('-------- MGB Char Name Line 437 Code -----------> ' + MGBdisplayName);
        return MGBdisplayName;
    } else {
		// const chatMGBDetails = getCurrentChatDetails();
		// const MGBdisplayName = chatDetails.characterName;
		// return MGBdisplayName;
		console.debug('-------- MGB Char Name Line 442 Code -----------> ' + characters[this_chid]?.name);
...
function registerFunctionTools() {
    ...
    try {
        ...
        registerFunctionTool({
            ...
            description: ` ${mgbName}\'s tool to get the weather for a specific location. Call when desired for current weather conditions.`,
        ...
        registerFunctionTool({
            ...
            description: ` ${mgbName}\'s tool to get the daily weather forecasts for the next 5 days for a specific location. Call when desired for the weather forecast.`,
