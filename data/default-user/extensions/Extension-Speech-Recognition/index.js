...
// MGB Edit to resize text field automatically xxxxxxxxxxxxxxxxxxxxxxxxxxxxx
		//  textarea.val(transcriptFormatted);
			let MGBmesgr = transcriptFormatted;

			textarea.val(MGBmesgr)[0].dispatchEvent(new Event('input', { bubbles: true }));
			console.debug('------------ MGB Dispatched Send Text Area Event From Speech Module ------------------');
				
// MGB End Edit xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx						
                    break;
...
// MGB Edit to resize text field automatically xxxxxxxxxxxxxxxxxxxxxxxxxxxxx
		//   textarea.val(existingMessage + ' ' + transcriptFormatted);
			let MGBmesg = existingMessage + ' ' + transcriptFormatted;

			textarea.val(MGBmesg)[0].dispatchEvent(new Event('input', { bubbles: true }));
			console.debug('------------ MGB Dispatched Send Text Area Event From Speech Module ------------------');
