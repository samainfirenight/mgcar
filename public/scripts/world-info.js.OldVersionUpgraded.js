...
function getWorldEntry(name, data, entry) {
	...
	// MGB Edit char Two exclude characters checkbox two
	...
	characterExclusionInputTwo.on('input', function () {
        const uid = $(this).data('uid');
        const value = $(this).prop('checked');
        ...
        setOriginalDataValue(data, uid, 'character_filterTwo', data.entries[uid].characterFilterTwo);
        saveWorldInfo(name, data);
    });
	// end edit
