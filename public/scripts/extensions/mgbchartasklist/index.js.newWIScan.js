...
function loadSettings() {
    ...
    $('#mgbchartasklist_include_wi_scan').prop('checked', extension_settings.memory.scan).trigger('input');	
...
function onMGBCharTaskListIncludeWIScanInput() {
    const value = !!$(this).prop('checked');
    extension_settings.mgbchartasklist.scan = value;
    reinsertMemory();
    saveSettingsDebounced();
}
...
function setupListeners() {
    ...
    $('#mgbchartasklist_include_wi_scan').off('input').on('input', onMGBCharTaskListIncludeWIScanInput);	
